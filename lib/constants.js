module.exports = {
  ...
  feeds: {
    ...
    DELETE_DONE: 'feeds-delete-done',
    DELETE_FAIL: 'feeds-delete-fail',
    FIND_FEED_DONE: 'feeds-find-done',
    FIND_FEED_FAIL: 'feeds-find-fail',
  ...
  search: {
    FIND_POST_QUERY_DONE: 'search-find-post-query-done',
    FIND_POST_QUERY_FAIL: 'search-find-post-query-fail',
