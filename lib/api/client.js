...
module.exports = class Api {
  ...
  static saveTags(data) {
    return ajax('/api/tags', 'POST', data);
  }
  ...
  static saveSubscription(subscription) {
    return ajax(`/api/subscriptions/${subscription._id}`, 'POST', subscription);
  }

  static markPostsAsRead(subscription) {
    return ajax(`/api/mark-posts-as-read/${subscription._id}`, 'POST', subscription);
  }
